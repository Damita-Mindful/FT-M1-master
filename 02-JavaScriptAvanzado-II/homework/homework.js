...
function getNombre(){
 ...
 // Escribir código, sin modificar lo que ya se encuentra escrito arriba, para poder llamar al método getNombre para obtener 
 // primero el nombre del instructor y luego para obtener el nombre del alumno.
